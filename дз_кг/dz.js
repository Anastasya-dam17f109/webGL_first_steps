...
const VSHADER_SOURCE =
    ...
    '        vLightWeighting =  vec4(a_color.rgb * nDotL ,1.0);\n'+
	'    }else{\n'+
...
//отрисовка преобразованного конуса 
	...
	n = initVertexBuffersElemsNew(gl,size_obj,nodeAmount,[0.0, 1.0, 0.0, 1.0],nodeContainer,1)
	let step = 3
	for(var i = 0; i< n; i+=step)
		gl.drawElements(gl.TRIANGLES, 3, gl.UNSIGNED_SHORT, i* size_obj.val)
	n = initVertexBuffersElemsNew(gl,size_obj,nodeAmount,[0.0, 1.0, 0.0, 1.0],nodeContainer,2)
	for(var i = 0; i< n; i+=step)
		gl.drawElements(gl.TRIANGLES, 3, gl.UNSIGNED_SHORT, i* size_obj.val)
	n = initVertexBuffersElemsNew(gl,size_obj,nodeAmount,[0.0, 1.0, 0.0, 1.0],nodeContainer,3)
	for(var i = 0; i< n; i+=step)
		gl.drawElements(gl.TRIANGLES, 3, gl.UNSIGNED_SHORT, i* size_obj.val)
